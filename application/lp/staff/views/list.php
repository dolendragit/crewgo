                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php foreach($stafflisting as $key => $val): ?>
                          <tr>
                            <td><?php echo $key+1;?></td>
                            <td><?php echo ($val['name'] != "") ? $val['name'] : 'N/A' ;?></td>
                            <td><?php echo ($val['phone_number'] != "") ? $val['phone_number'] : 'N/A' ;?></td>
                            <td>
                              <?php foreach($val['skillset'] as $myval):?>
                                  <?php echo $myval['skillname'];?> >  <?php echo $myval['levelname'];?> <br/>
                              <?php endforeach;?>
                            </td>
                            <td><?php echo ($val['created_on'] != "") ? $val['created_on'] : 'N/A' ;?></td>
                            <td><?php echo ($val['active'] == 1) ? 'Active' : 'Suspended' ;?></td>
                            <td><a href="<?php echo base_url('lp/staff/edit/'.$val['id']);?>"><i class="fa fa-pencil"></i></a></td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
