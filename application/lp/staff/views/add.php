   ...
   <div class="row" style="padding-top: 20px;">
     <?php $this->load->view('home/alert');?>
      <div class="panel panel-default">
         <div class="panel-heading">Add LP Staff</div>
         <div class="panel-body">
            <!--change password form-->
            <form method="post" id="staffadd" action="<?php echo base_url('lp/staff/add'); ?>" id="staff" enctype="multipart/form-data">
              ...
              <div class="form-group  <?php echo form_error('address') ? 'has-error' : '' ?>">
                ...
                <div class="row">
                  <div class="col-sm-2 clockpicker <?php echo form_error('from') ? 'has-error' : '' ?>" data-align="top" data-autoclose="true">
                   ...
                   <div class="col-sm-2 clockpicker <?php echo form_error('to') ? 'has-error' : '' ?>" data-align="top" data-autoclose="true">
              ...
              <div class="form-group  <?php echo form_error('workhours') ? 'has-error' : '' ?>">
               ...
               <div class="form-group  <?php echo form_error('contactablehours') ? 'has-error' : '' ?>">
                ...
                <div class="row">
                  <div class="col-sm-2 clockpicker" data-align="top" data-autoclose="true">
               ...
               <div class="row">
                ...
                <div class="col-sm-3">
                   <div class="form-group  <?php echo form_error('driving_expiry') ? 'has-error' : '' ?>">
                      <label for="exampleInputareas1">Document Expiry Date<span class="mandatory">&nbsp;*</span></label>
