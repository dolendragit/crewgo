                       ...
                       <table class="table table-bordered">
                          ...
                          <?php foreach($skill as $key => $value):?>
                            <tr>
                              ...
                              <td><a href="<?php echo base_url('lp/staff/editskills/'.$value->id);?>"><i class="fa fa-pencil"></i></a> &nbsp; <a href="<?php echo base_url('lp/staff/deleteskill/'.$value->id . '/'.$value->staff_user_id);?>" onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i></a> </td>
                            </tr>
                          <?php endforeach;?>
                       </table>
                     </div>
                     ...
                     <div class="col-sm-6">
                       <div class="panel panel-default">
                         ...
                         <div class="panel panel-body">
                          <div class="row-fluid">
                            <form action="<?php echo base_url('lp/staff/addskill');?>" method="post">
