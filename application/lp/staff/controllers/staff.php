...
class Staff extends Base_Controller
{
    ...
    public function index()
    {
        ...
        $data['stafflisting'] = $this->staff_model->getAllUserDetailWithMultipleSkillSet($this->users->id);
 ...
 */
    ...
    public function addskill()
    {
        if ($this->input->post()) {
            ...
            if ($this->staff_model->addNewSkillViaEdit($data)) {
                ...
                redirect('lp/staff/edit/' . $data['staff_user_id'] . '?tb=skills');
            } else {
    ...
    public function editskills($rowId = null)
    {
        ...
        if ($this->input->post()) {
            ...
            if ($this->staff_model->updateSkillViaEdit($data, $this->input->post('userid'), $this->input->post('skillid'))) {
                //success
                $this->session->set_flashdata('success', 'Skills updated successfully');
                redirect('lp/staff/edit/' . $this->input->post('userid') . '?tb=skills');
            } else {
    ...
    public function deleteskill($id, $user)
    {
        ...
        redirect('lp/staff/edit/' . $user . '?tb=skills');
    }
    ...
    public function addqualification()
    {
        if ($this->input->post()) {
            ...
            redirect('lp/staff/edit/' . $this->input->post('myuserid') . '?tb=qualification');
    ...
    public function editqualification($id)
    {
        ...
        if ($this->input->post()) {
            ...
            redirect('lp/staff/edit/' . $this->input->post('userid') . '?tb=qualification');
    ...
    public function deletequalification($id, $userid)
    {
        ...
        redirect('lp/staff/edit/' . $userid . '?tb=qualification');
    }
    ...
    public function addtraining()
    {
        if ($this->input->post()) {
            ...
            redirect('lp/staff/edit/' . $this->input->post('myuserid') . '?tb=training');
    ...
    public function deletetraining($id, $userid)
    {
        ...
        redirect('lp/staff/edit/' . $userid . '?tb=training');
    }
    ...
    public function edittraining($id)
    {
        ...
        if ($this->input->post()) {
            ...
            redirect('lp/staff/edit/' . $this->input->post('userid') . '?tb=training');
