    	...
    	<div class="panel panel-default">
    		<div class="panel-content">
    			<div class="row content-wrapper">
	    			...
	    			<div class="col-sm-3">
	    				<form class="form-horizontal" method="get" action="<?php echo base_url('lp/wagerule');?>">
...
$(function(){
	...
	$('.country').on('change', function(){
		...
		$.ajax({
			type: "post",
			url: "<?php echo base_url(); ?>" + 'lp/wagerule/getStates',
         ...
         $('.subskill').html('');
         	...
         	var fromurl;
       		var parsed = parseURLParams("<?php echo $_SERVER["REQUEST_URI"] ;?>");
       		 ...
       		 if (typeof parsed === "undefined" || typeof parsed.subskill === "undefined"){
				  	fromurl = "";
				} else  {
	...
	$('.calendar').on('change', function(){
		...
		$.ajax({
			type: 'POST',
			url: "<?php echo base_url(); ?>" + 'lp/wagerule/getCalendar',
