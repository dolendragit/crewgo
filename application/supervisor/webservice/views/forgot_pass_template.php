                ...
                <tr>
                  <td>
                    ...
                    <table class="row" style="width:100%;">
                      <tr style="background:#fdd207; text-align:center; width:100%;">
                          ...
                          <table class="twelve columns" style="width:100%;">
                            <tr class="email-heading">
                              <td class="center text-pad">
                                <center>
                                  <h1 style="font-size: 32px;    font-weight: bold;    text-align: center;    padding:15px 0;">Reset your password</h1>
                                </center>
                              </td>
                            </tr>
                          </table>
                          ...
                          <table class="twelve columns">
                            <tr class="email-content">
                              <td class="text-pad" style="padding:0 15px;">
                                ...
                                <p style="font-size: 16px;">Please <?php echo $forgot_link; ?> to change the password.</p>                                
                              </td>
