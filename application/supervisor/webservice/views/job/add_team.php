...
<form method="POST" action="<?php echo customer_interface_url(uri_string()); ?>" role="form"  class="form-horizontal" enctype="multipart/form-data" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9"><input class="form-control" type="text" name="team_name" value="" /></div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9"><input class="form-control" type="text" name="operation" value="" />add, edit</div>
    </div><div class="form-group">
        <label class="col-sm-3 control-label">  Staffs:</label>
        <div class="col-sm-9"><input class="form-control" type="text" name="staffs" value="" />(staff ids seperated by comma(,))</div>
    </div>
