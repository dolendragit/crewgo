<form id="work_hours_wage_rate" method="post" class="form-horizontal calender" role="form" onsubmit="return validateWorkHourForm()">
                                 ...
                                 <div class="col-sm-8">
                                   <select  name="p_day" id="p_day"   class="form-control">
                                       ...
                                       if($days){
                                           foreach($days as $day){
                                       ?>
                                        <option value="<?php echo $day->day_id;?>" <?php echo set_select('p_day',$day->day_id,@$work_hour_wage_rate_rule->day_id == $day->day_id?true:false); ?>>
                                ...
                                <div class="col-sm-4">
                                     ...
                                     <div class="col-sm-7">
                                         <select name="sp_shift_type_id" id="sp_shift_type_id" class="form-control" onchange="changeShiftTime(this.value)">
                                             ...
                                             ?>
                                             <option value="<?php echo $stype->id;?>" <?php echo set_select('sp_shift_type_id',$stype->id,@$work_hour_wage_rate_rule->shift_type_id==$stype->id?true:false);?>><?php echo $stype->name;?></option>
                                             <?php
                                                 }
                                             }
                                             ?>
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-sm-4">
                               <label class="control-label col-sm-4" for="Calendar">
                                 ...
                                 <div class="col-sm-8">
                                     <input type="text" name="sp_lp_charge" id="sp_lp_charge" class="form-control"  onkeypress="return isNumber(event)" maxlength="4" value="<?php echo @$work_hour_wage_rate_rule->lhc_charge;?>">
                            ...
                            <div class="col-sm-4">
                               <label class="control-label col-sm-6" for="From"> From-To :    <span class="required"></span>
                                ...
                                <div class="col-sm-6" id="shift_from_to" style="margin-top:10px;">
                                    <?php if(@$work_hour_wage_rate_rule) { 
                                      echo  $this->model_master_data->formatTime($work_hour_wage_rate_rule->time_from).'-'.$this->model_master_data->formatTime($work_hour_wage_rate_rule->time_to); 
                             ...
                             <div class="col-sm-4">
                               <label class="control-label col-sm-7" for="Pay Rate">Pay Rate <span class="required">*</span>
                                 ...
                                 <div class="col-sm-5">
                                      ...
                                      <input type="text" name="sp_manual_rate" id="sp_manual_rate" class="form-control" onkeypress="return isNumber(event)"   maxlength="5" value="<?php echo @$work_hour_wage_rate_rule->pay_rate=='0.00'?'':$work_hour_wage_rate_rule->pay_rate;?>">
                       ...
                       <div class="form-group">
                           ...
                           <div class="col-sm-12">
                               <label class="control-label col-sm-3" for="Calendar">
                                 ...
                                 <div class="col-sm-9">
                                     <input type="text" name="customer_rule_name" id="customer_rule_name" class="form-control" value="<?php echo @$work_hour_wage_rate_rule->customer_rule_name;?>">
                       ...
                       <div class="form-group">
                            <div class="col-sm-12">
                               <label class="control-label col-sm-3" for="Calendar">Rule name for LP <span class="required"></span>
                                 ...
                                 <div class="col-sm-9">
                                    <input type="text" name="lhc_rule_name" id="lhc_rule_name" class="form-control" value="<?php echo @$work_hour_wage_rate_rule->lhc_rule_name;?>">
                                </div> 
	...
	<span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span>		  
          ...
          <div class="modal-footer">
              <input type="hidden" name="hidden_id" id="hidden_id" value="<?php echo $this->input->post('load_wr')=='work_hours'?@$work_hour_wage_rate_rule->id:"";?>"> 
            <button type="button" class="btn btn-default antoclose" data-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-primary antosubmit"><?php echo @$work_hour_wage_rate_rule->id!="" && $this->input->post('load_wr')=='work_hours' ?'Save Changes':'Save';?></button>
          </div>
        </div>
      </form> 
     ...
     var error_msg = ""; 
      ...
      if(sp_manual_rate==""){
       ...
       $('#sp_form_errors_msg').html('');
        ...
        $.ajax({
        url:'<?php echo base_url('admin/wage_rate/saveWorkHour');?>',
        type:'post',
        dataType: 'json',
        data: $('#work_hours_wage_rate').serialize(),
            success:function(data){
                 
                if(data.status == '1'){
                    $("#special_day_rule_add_container .close").click();
                    document.getElementById('work_hours_wage_rate').reset();
                     $("#mydiv").hide();//close
                     callWRContainer();
