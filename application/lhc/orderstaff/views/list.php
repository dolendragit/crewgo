    ...
    <?php $this->load->view('home/alert');?>
          ...
          <form method="post" action="<?php echo base_url('lhc/orderstaff');?>">
                                <div class="col-sm-6">
...
$(document).on('click', '.job-listing', function(){
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url();?>" + "lhc/orderstaff/staffdata"+ "?sk_id=<?php echo $this->input->get('sk_id');?>&l_id=<?php echo $this->input->get('l_id');?>",
        data: {myvalue: selectedJob},
        dataType: 'json',
        cache:false,
        beforeSend: function(){
