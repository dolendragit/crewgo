   ...
   <div class="login_wrapper">
      <div class="animate form login_form">
        ...
        <?php endif;?>
            ...
            <?php echo form_open(base_url('lhc/admin'));?>
            <div>
               <img class="admin-logo" src="<?php echo base_url('assets/images').'/'.CRUVA_ADMIN_LOGO;?>"><span class="after-logo-text">  LHC Login </span>
            </div>
            <div>         
   ...
   <div class="modal-dialog">
      ...
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h4 class="modal-title">LHC Admin</h4>
         </div>
         <div class="modal-body">
            <section class="login_content">
               <form  name="forgot_password" method="post" action="<?php echo base_url('lhc/admin/forgotpassword');?>">
