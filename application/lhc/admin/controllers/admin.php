...
class Admin extends Base_Controller
{
    ...
    public function sendResetEmail($email, $code)
    {
        ...
        $encrypt_hash             = $code;
        $_POST['activation_code'] = '<a href="' . base_url('lhc/admin/resetpassword') . '/' . $encrypt_hash . '" title="Reset Password" style="color:#f4eb38">' . base_url('lhc/admin/resetpassword') . '/' . $encrypt_hash . '</a>';
        $_POST['email']           = $email;
