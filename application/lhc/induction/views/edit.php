     ...
     <?php $this->load->view('home/alert');?>
      <div class="panel panel-default">
         ...
         <div class="panel-body">
            ...
            <form method="post" action="<?php echo base_url('lhc/induction/edit'); ?>" id="staff" enctype="multipart/form-data">
            ...
            <input type="hidden" name="inductionid" value="<?php echo $induction->id;?>">
              ...
              <div class="form-group  <?php echo form_error('name') ? 'has-error' : '' ?>">
               ...
               <div class="form-group  <?php echo form_error('email') ? 'has-error' : '' ?>">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="e.g http://test.com" name="url" value="<?php echo $induction->document_url;?>">
