                       ...
                       <table class="table table-bordered">
                          ...
                          <?php foreach($qualification as $key => $value):?>
                            <tr>
                              ...
                              <td><a href="<?php echo base_url('lhc/staff/editqualification/'.$value->id);?>"><i class="fa fa-pencil"></i></a> &nbsp; <a href="<?php echo base_url('lhc/staff/deletequalification/'.$value->id . '/'.$value->staff_user_id);?>" onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i></a> </td>
                            </tr>
                          <?php endforeach;?>
                       </table>
                     </div>
                     ...
                     <div class="col-sm-6">
                       <div class="panel panel-default">
                         ...
                         <div class="panel panel-body">
                          <div class="row-fluid">
                            <form action="<?php echo base_url('lhc/staff/addqualification');?>" method="post" enctype="multipart/form-data">
