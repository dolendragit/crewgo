...
class Wagerule_model extends CI_Model
{
    ...
    public function specialDayRules($filters)
    {
        ...
        $query = $this->db->select('tbl_wr_shift_type.name as shiftname, tbl_wr_shift_type.time_from as timefrom, tbl_wr_shift_type.time_to as timeto, tbl_wr_calendar.date as calendardate, tbl_wr_special_day.*')
            ...
            ->where('tbl_wr_special_day.skill_id', $filters['skill'])
            ->where('tbl_wr_special_day.level_id', $filters['subskill'])
            ->get();
    ...
    {
        $query = $this->db->select('tbl_wr_shift_type.name as shiftname,tbl_wr_overtime.*, tbl_wr_interval.name as intervalname, tbl_wr_day.name as dayname')
            ...
            ->where('tbl_wr_overtime.skill_id', $filters['skill'])
            ->where('tbl_wr_overtime.level_id', $filters['subskill'])
            ->get();
    ...
    {
        $query = $this->db->select('tbl_wr_bk_not_taken.*, tbl_wr_day.name as mydayname, tbl_wr_shift_type.time_from, tbl_wr_shift_type.time_to')
            ...
            ->where('tbl_wr_bk_not_taken.skill_id', $filters['skill'])
            ->where('tbl_wr_bk_not_taken.level_id', $filters['subskill'])
            ->get();
    ...
    public function getWorkHours($filters)
    {
         $query = $this->db->select('tbl_wr_work_hour.*, tbl_wr_day.name as myday, tbl_wr_shift_type.name as myshiftname, tbl_wr_shift_type.time_from, tbl_wr_shift_type.time_to')
            ...
            ->where('tbl_wr_work_hour.skill_id', $filters['skill'])
            ->where('tbl_wr_work_hour.level_id', $filters['subskill'])
            ->get();
